...
register_connection_type("underground-belt",
	{
		...
		accepts_outside_entity = function(outside_entity, factory, interior, conn_specs)
			...
			if outside_entity.type == "underground-belt" then
				if outside_entity.direction == conn_specs.direction_in and outside_entity.belt_to_ground_type == "output" then
					...
					inwards = (outside_entity.belt_to_ground_type == "output")
				elseif outside_entity.direction == conn_specs.direction_out and outside_entity.belt_to_ground_type == "input" then
